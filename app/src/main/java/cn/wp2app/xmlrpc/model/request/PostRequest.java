...
import cn.wp2app.xmlrpc.enums.PostType;
...
import static cn.wp2app.xmlrpc.enums.PostTaxonomy.CATEGORY;
import static cn.wp2app.xmlrpc.enums.PostTaxonomy.TAG;
import static cn.wp2app.xmlrpc.enums.PostType.POST;
...
public class PostRequest extends Request {
    ...
    public void setCategories(String... categories) {
        if (null == termsNames) {
            setTermsNames(new HashMap<String,String[]>(2));
        }
